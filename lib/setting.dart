...
// Importing the registration page and home pagerrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr
...
// Halaman Pengaturan sesuai dengan desain yang diberikan
...
class _SettingsPageState extends State<SettingsPage> {
  ...
  void initState() {
    ...
    _nameController.text = 'Valhazz';
    _emailController.text = 'Evalyto@gmail.com';
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  _buildNavItem(Icons.article, 'Berita', 1),
                  _buildNavItem(Icons.grid_3x3, 'Formulir', 2),
                  _buildNavItem(Icons.photo_camera, 'Pengaturan', 3, isSelected: true),
                ],
              ),
            ),
          ],
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          ...
          if (index == 3) { // Pengaturan button (index 3)
            Navigator.push(
              context,
